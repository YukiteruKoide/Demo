...
# MAGIC %sh
# MAGIC head /Volumes/databricks_handson/handson_db/handson_volume/customer.csv
...
df = (
  ...
  .load('/Volumes/databricks_handson/handson_db/handson_volume/customer.csv') 
)
...
# MAGIC USING CSV
# MAGIC OPTIONS (path "/Volumes/databricks_handson/handson_db/handson_volume/customer.csv", header "true", mode "FAILFAST");
# MAGIC SELECT * FROM CONTRACT

# COMMAND ----------

# DBTITLE 1,データのクレンジング
...
info_df = spark.read.table("databricks_handson.handson_db.customer_info")
